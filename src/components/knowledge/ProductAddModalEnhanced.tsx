...
export const ProductAddModalEnhanced = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={!isProcessing ? onClose : undefined}>
      <DialogContent className="max-w-[72rem] h-[calc(100vh-4rem)] max-h-[850px] p-0 bg-transparent border-0 overflow-hidden">
        {/* Navigation Arrows */}
        ...
        <div className="relative w-full h-full">
          <div className="absolute inset-0 bg-gradient-to-br from-[#0A0E1B]/95 to-[#1A1F36]/95 backdrop-blur-xl rounded-3xl 
                          border border-white/10 shadow-2xl animate-in fade-in-0 zoom-in-95 duration-300">
            ...
            {/* Body */}
            <div className="flex-1 overflow-y-auto px-6 py-6 max-h-[calc(100%-8rem)]
